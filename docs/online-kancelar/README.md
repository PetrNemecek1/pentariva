...
| Soubor | Obsah |
|---|---|
| [00-zadani-a-rozhodnuti.md](00-zadani-a-rozhodnuti.md) | Mise, zdroje pravdy, rozhodnutí zadavatele R1–R25, fáze |
...
| [22-architektura-administrace.md](22-architektura-administrace.md) | **Informační architektura administrace** (audit: ploché menu 21 položek, žádný tooltip komponent, kategorie jako 3 pole bez popisku, surové enumy, nastavení jako volný text): menu sekce → podsekce dle Shoptetu, vzory obrazovek (seznam / detail / nastavení / průvodce), produkt v záložkách, **Kategorie jako strom s pořadím produktů per kategorie**, kde co řídí řazení ve výpisech, jednotný systém nápovědy (`Field` s povinným `help`, `HelpHint`, `ActionButton` s důsledkem a potvrzením, „?" → kapitola nápovědy), ⌘K hledání, checklist oprav všech obrazovek |
| [23-rozdeleni-prace-go-live-cz-sk.md](23-rozdeleni-prace-go-live-cz-sk.md) | **Rozdělení práce před go-live CZ + SK (R23)**: tři paralelní proudy — Doklady (PDF, ISDOC, testovací doklady, účetní export per trh/měna/entita), Multishop fáze B (admin Trhy, `market_settings`, akce/e-maily/právo per trh, peníze per měna, storefront SK, D38 testy), Správa objednávek a expedice (CRUD provozních stavů, hromadné akce, worker `shipping_jobs`, Packeta CZ+SK, digitální doručení, R21, výjimky 21 C); **závazné rozhraní mezi proudy** (vlastnictví tabulek, řady pgTAP 050/060/070, větve, CI kvóta) |
| [24-stav-a-navazani-2026-08-23.md](24-stav-a-navazani-2026-08-23.md) | **Stav systému a navázání po pauze (23. 8. 2026)**: co je v produkci a co je záměrně vypnuté, co se dodělalo, co chybí podle toho, kdo to odblokuje (vstupy zadavatele / technické zbytky / odložené), rizika během pauzy (GitHub billing → zálohy a CI), pořadí dalších kroků, jak prakticky navázat |
| [25-revize-ekosystem-master-1-0.md](25-revize-ekosystem-master-1-0.md) | **Revize balíku „PENTARIVA EKOSYSTÉM“ MASTER 1.0 (22. 8. 2026)** proti modelu v produkci: co sedí (20/8/4, Benefit 3/6/10, uvítací výhoda, kontroly), rozdíly k rozhodnutí (měsíční kvalifikace rolí + sestup + převod týmu, pool 2 %, provize není kredit, dávková výplata, doprava partnera, IČO před aktivací, B2B 30/40/45 čtvrtletně bez provize získavateli, Partner Point, hybridní prodejna), 13 otázek kolegovi, chyby v balíku, odhad dopadu |
