...
| R21 | **Neaktivní partner (návrh 22. 8. 2026, ke schválení zadavatelem):** deaktivovaný partner nedostává nové provize, jeho podíl z linie zůstává firmě, downline se nepřesouvá (bez komprese), jeho zákazníci zůstávají přiřazeni; zůstatek lze vyplatit do 12 měsíců po ukončení (konfigurovatelně). Zadání: `21` C.5. |
